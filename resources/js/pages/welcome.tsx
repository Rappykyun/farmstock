...
import { ArrowRight, PackageSearch, Sprout, Tractor } from 'lucide-react';
                ...
                <header className="border-b border-black/5 bg-[#f7f5ef]/95 backdrop-blur">
                    <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                        ...
                        >
                            ...
                            <div>
                                <p className="text-sm font-semibold tracking-[0.18em] text-[#244131] uppercase">
                                    FarmStock
                                </p>
                        ...
                        <nav className="flex items-center gap-2">
                            {auth.user ? (
                                <Button
                                    asChild
                                    size="sm"
                                    className="bg-[#244131] hover:bg-[#1c3326]"
                                >
                ...
                <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
                    <section className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
                        <div className="space-y-6">
                            <p className="text-sm font-medium tracking-[0.16em] text-[#667267] uppercase">
                                Farm marketplace made simpler
                            </p>

                            <h1 className="max-w-4xl text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
                                A cleaner way for consumers and farmers to work
                                together.
                            </h1>

                            <p className="max-w-2xl text-base leading-7 text-[#5c675f] sm:text-lg">
                                FarmStock helps buyers discover available
                                products and helps farmers manage listings,
                                stock, and requests in one place.
                            </p>
                            ...
                            <CardContent className="space-y-5 p-6 lg:p-8">
                                ...
                                <div className="space-y-4">
                                    {highlights.map((item) => (
                                        <div
                                            key={item.title}
                                            className="rounded-2xl border border-black/5 bg-[#fbfaf7] p-4"
                                        >
                    ...
                    <section className="mt-12 grid gap-5 md:grid-cols-2">
                        {audienceSections.map((section) => (
                            <Card
                                key={section.title}
                                className="border-black/5 bg-white/80 shadow-none"
                            >
